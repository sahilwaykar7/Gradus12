import { EntriesComponent } from '../../feature/session/entries/entries.component';
...
export const verticalMenuItems = [ 
    ...
    // new Menu (14, 'Snackbar', '/ui/snackbar', null, 'sms', null, false, 3), 
    ...
    new Menu (300, 'Entries', null, null, 'format_list_bulleted', null, true, 0),
    new Menu (301, 'Cash Memo', null, null, 'folder_open', null, true, 300),
    new Menu (302, 'AO', null, null, 'folder_open', null, true, 300),
    new Menu (303, 'Challan', null, null, 'folder_open', null, true, 300),
    new Menu (304, 'Stock', null, null, 'folder_open', null, true, 300),
    new Menu (305, 'Accounts', null, null, 'folder_open', null, true, 300),
    new Menu (315, 'Printing', "/printing", null, 'format_list_bulleted', null, false, 0),
    new Menu (316, 'Query', null, null, 'format_list_bulleted', null, true, 0),
    new Menu (321, 'Stock Query', '/query/stock', null, 'inventory_2', null, false, 316),
    new Menu (322, 'Party Query', '/query/party', null, 'people', null, false, 316),
    new Menu (323, 'Card Ledger', '/query/ledger', null, 'credit_card', null, false, 316),
    new Menu (324, 'Amount Found', '/query/amount', null, 'attach_money', null, false, 316),
    new Menu (317, 'Followup', "/followup", null, 'format_list_bulleted', null, false, 0),
    new Menu (318, 'Reports', "/reports", null, 'format_list_bulleted', null, false, 0),
    new Menu (319, 'Masters', "/masters", null, 'format_list_bulleted', null, false, 0),
    new Menu (320, 'Miscellaneous', "/miscellaneous", null, 'format_list_bulleted', null, false, 0),
